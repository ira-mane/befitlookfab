...
//           <h2 clasimport React from "react";
// import logo1 from '../assets/images/logo1.png'
...
// export default React.memo(Valuent-bold text-lg md:text-xl lg:text-2xl text-white mb-2">Evidence Based</h2>
//           <p className="text-gray-100 text-sm md:text-base lg:text-lg">Evidence-based dietician, effective personalized nutrition diet plans.</p>
//         </div>
//       </div>
//     </div>
...
const Value = () => {
  ...
  <div className="grid grid-cols-1 md:grid-cols-5 lg:grid-cols-5 gap-4 md:gap-8 lg:gap-12">
    ...
    <div className="col-span-3 md:col-span-3 lg:col-span-3 bg-[#81b622] p-4 md:p-6 lg:p-8 rounded-lg shadow-md">
      ...
      <p className="text-gray-100 text-lg md:text-xl lg:text-2xl">We believe in empathy and best personalized plans to make you more confident in your journey.        Our mission is to help individuals achieve sustainable weight loss by providing personalized diet plans and ongoing support.</p>
    </div>
    ...
    <div className="col-span-1 md:col-span-1 lg:col-span-1 bg-[#3b5704] p-3 md:p-5 lg:p-7 rounded-lg shadow-md">
      ...
      <p className="text-gray-100 text-lg md:text-xl lg:text-2xl">Clients can trust as our approach is based on best practices in the field.</p>
    </div>
    <div className="col-span-1 md:col-span-1 lg:col-span-1 bg-[#81B622] p-3 md:p-5 lg:p-7 rounded-lg shadow-md">
      ...
      <p className="text-gray-100 text-lg md:text-xl lg:text-2xl">Evidence-based dietician, effective personalized nutrition diet plans.</p>
    </div>
  </div>
</div>
  );
