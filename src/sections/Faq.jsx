...
const faqs = [
  ...
  },
  {
    ...
    desc: "You can book a appointment directly by clicking on Booking button or register button and filling the form. If that doesn't work then you can either mail us at befitlookfab@gmail.com or fill contact form on the website.",
  },
  {
  ...
  {
    title: "Are the result guarantee ?",
    desc: "In any health care program, anywhere in the world there will not be any guarantee. If you are dedicated, follow our diet plans & advice; RESULTS will follow.Key is to engage with the mentor for any difficulty as she will do all in her power to make it easy and explain things to you. If that be the case, results are sure.",
  }
];
