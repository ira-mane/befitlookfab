    ...
    return (
        <>
            {/* <section className='flex flex-col lg:flex-row justify-between items-center gap-4 w-full bg-[#F8FFE8] h-auto lg:h-screen'>
                <div className='flex justify-center items-start flex-col gap-7 lg:w-1/2 px-8 py-10 lg:px-20 lg:py-20 md:px-12 md:py-15 sm:px-8 sm:py-10'>
                    <h1 className='text-[#3B5704] font-bold text-4xl lg:text-5xl md:text-5xl sm:text-4xl'>Priotizing physical fitness and self care for<span className='text-[#81B622]'> healthy</span> and confidence appearance.</h1>
                    <p className='text-[#0d1106] text-2xl lg:text-2xl md:text-xl sm:text-xl'>Book a consultation today with top-rated dietitian! Achieve your healthy goals with personalized nutrition plans tailored just for you.</p>
                    <div className='flex justify-center items-center gap-7'>
                        <a href='/booking'>
                            <button className='bg-[#3B5704] text-white px-4 lg:px-8 py-3 rounded-md text-[18px] lg:text-2xl md:text-xl sm:text-lg hover:bg-black hover:text-white cursor-pointer'>Register Now</button>
                        </a>
                        <a href="https://www.instagram.com/befitlookfab" target="_blank" rel="noopener noreferrer">
                            <button className='border-2 border-[#3B5704] text-[#3b5704] text-[18px] lg:text-2xl md:text-xl sm:text-lg rounded-md px-4 lg:px-8 py-3 hover:border-black hover:text-black cursor-pointer'>Watch Video</button>
                        </a>
                    </div>
                </div>
                <div className='relative h-full flex justify-center item-center w-1/2 px-5 py-20 object-cover lg:w-1/2 md:w-1/2 sm:w-full'>
                    <img src={Heroimg} alt="Yoga Lady/Healthy Diet/Nutrition" width={150} height={500} className='lg:w-full md:w-full sm:w-full' />
                </div>
            </section> */}
            <section className='flex flex-col lg:flex-row justify-between items-center gap-4 w-full bg-[#F8FFE8] h-auto lg:h-screen'>
